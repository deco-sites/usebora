...
const variants = {
  ...
  icon:
    "h-[36px] px-2 rounded-full bg-transparent text-default border-transparent hover:bg-transparent active:border-interactive disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none",
  arrows: "bg-transparent rounded-none border-none",
};
